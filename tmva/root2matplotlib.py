# The initial version of this file is a copy of the file
# rootpy/plotting/root2matplotlib.py from the rootpy project
# <https://github.com/rootpy/rootpy>.
#
# It is distributed under the terms of GNU GPL (same as rootpy)
#
# The purpose of including here is to be able to convert ROOT to
# Matplotlib plottables, without requiring a dependency on rootpy.
